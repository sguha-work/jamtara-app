...
// This screen will be seen by agent himself
class AgentProfile extends StatefulWidget {
  final UserModel? supervisor;
  const AgentProfile(this.supervisor);
  @override
  State<AgentProfile> createState() => _AgentProfile();
}

class _AgentProfile extends State<AgentProfile> {
  ...
  bool _validate() {
    ...
    if (aadharController.text.trim() == '') {
      _displayError('Agent aadhar number cannot be empty');
      return false;
    }
    if (areaController.text.trim() == '') {
      _displayError('Agent area cannot be empty');
      return false;
    }
    return true;
  }
