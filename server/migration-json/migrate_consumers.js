...
const csvFilePath = './consumer_csv/Giridhih_North.csv';
...
csv()
    ...
    .then(async (jsonObj) => {
        ...
        // console.log(jsonObj);
        const message = fs.createWriteStream(`${__dirname}/consumer_csv/${timestamp}_Giridhih_North.log`);
        try {
        ...
        // const message = fs.createWriteStream(__dirname + "/consumer_csv/Giridhih_North.json");
